...
/**
 * Represents the Saver card in the wild card category.
 * This class extends the {@code Wild} class and initializes a Saver card 
 * with the specified attributes.
 */
public class Saver extends Wild {

    /**
     * Constructs a Saver card with the specified attributes.
     *
